...
import { NavbarStaticTopComponent } from './shared/navbar-static-top/navbar-static-top.component';
import { MessagesMenuComponent } from './shared/navbar-static-top/messages-menu/messages-menu.component';
import { NotificationsMenuComponent } from './shared/navbar-static-top/notifications-menu/notifications-menu.component';
import { TasksMenuComponent } from './shared/navbar-static-top/tasks-menu/tasks-menu.component';
import { UserMenuComponent } from './shared/navbar-static-top/user-menu/user-menu.component';
